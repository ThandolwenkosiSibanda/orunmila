...
class MyLoadProposalView extends Component {
	componentDidMount() {
				...
				<div className="content-wrapper">
					<div className="row">
							...
							<div className="card">
								<div className="card-header">
									...
									<div className="card-title">
										<div className="">
											<p className="divider" />
											<h6>Submitted : {moment(this.props.createdAt).fromNow()}</h6>
										</div>
									</div>
								</div>
						...
						<div className="col-xl-3 col-lg-3 col-md-3 col-sm-12">
							<div className="card">
								<div className="card-body">
									<h6>Transporters Details</h6>
									<p>Name : {this.props.proposal.user.surname}</p>
									<p>Loads Transported : 5</p>
									<p>Rating : 5</p>
...
export default connect(mapStateToprops, { fetchProposal, addChatroom, fetchChatrooms, fetchChatroom })(
	MyLoadProposalView
);
