...
const LoadsFilteredReducer = (state = {}, action) => {
	switch (action.type) {
		case 'FETCH_LOADS_FILTERED_REQUEST':
			return { ...state, loading: true };
		case 'FETCH_LOADS_FILTERED_SUCCESS':
			let copy = Object.assign({}, state);
			delete copy.loading;
			return { ..._.mapKeys(action.payload, '_id') };
		case 'FETCH_LOADS_FILTERED_FAILURE':
...
export default LoadsFilteredReducer;
